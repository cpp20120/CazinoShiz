...
public static class Locales
{
    ...
    public static string Help() => string.Join("\n", [
        "<b>🎰 CasinoShiz — игры и команды</b>",
        "",
        "🎰 <b>Слоты</b> — кинь 🎰. 3 семёрки → 77 монет, другие тройки — выплата, 2 одинаковых — компенсация. 3 крутки в день, обнуление в 00:00. Иногда выпадают подарочные коды — следи за чатом!",
        "",
        "🎲 <b>Кубик</b> — <code>/dice bet &lt;сумма&gt;</code>, затем кинь 🎲. Выплаты: 4→x2, 5→x3, 6→x5.",
        "",
        "🎯 <b>Дартс</b> — <code>/darts bet &lt;сумма&gt;</code>, затем кинь 🎯. Выплаты: 4→x2, 5→x3, 6 (в яблочко)→x6.",
        "",
        "🐎 <b>Скачки</b> — <code>/horse bet &lt;номер&gt; &lt;сумма&gt;</code>. Подробнее: <code>/horse help</code>.",
        "",
        "🃏 <b>Блэкджек</b> — <code>/blackjack &lt;ставка&gt;</code>. Кнопки: Ещё / Стоп / Удвоить.",
        "",
