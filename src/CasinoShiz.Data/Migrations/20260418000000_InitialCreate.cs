    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                IssuedBy = table.Column<long>(type: "INTEGER", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                HasActedThisRound = table.Column<bool>(type: "INTEGER", nullable: false),
                ChatId = table.Column<long>(type: "INTEGER", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            {
                InviteCode = table.Column<string>(type: "TEXT", maxLength: 8, nullable: false),
                HostUserId = table.Column<long>(type: "INTEGER", nullable: false),
                Status = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                LastActionAt = table.Column<long>(type: "INTEGER", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LastDayUtc = table.Column<long>(type: "INTEGER", nullable: false),
